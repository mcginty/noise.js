...
ColorNoise.prototype = {
	...
	value:	0,
	reset: function(opts){
		this.sampleRate	= isNaN(opts.sampleRate) ? this.sampleRate : opts.sampleRate;
		this.color		= typeof opts.color === 'string' ? opts.color : this.color;
		this.c1			= (1 << this.q) - 1;
		this.c2			= (~~(this.c1 /3)) + 1;
		this.c3			= 1 / this.c1;
		this.c1			= this.c2 * 6;
...
*/
	reset: function(opts){
		this.phase = this._p = isNaN(opts.p) ? 0 : opts.p;
	},
/**
...
// Geneneration
audioLib.ColorNoise		= ColorNoise;
...
}(['ColorNoise', 'Oscillator', 'Sampler', 'ADSREnvelope', 'StepSequencer', 'UIControl']));

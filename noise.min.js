this.audioLib=function AUDIOLIB(m,k,v,o){function n(h){h=new ea(h);h.subarray=h.subarray||h.slice;return h}function A(h,a,b,c){F?F(h,a,{get:function(){return b},enumerable:!!c}):h[a]=b}function S(h){var a=arguments,b=a.length,c,e;for(c=1;c<b;c++)for(e in a[c])a[c].hasOwnProperty(e)&&(h[e]=a[c][e]);return h}function J(h,a,b){var c;if(!b)if(b=[],c=/^\s*function\s*\w*\s*\(([^\)]+)/.exec(a))c[1].replace(/[a-z$_0-9]+/ig,function(c){b.push(c)});else for(c=0;c<a.length;c++)b[c]=o(c+2).join("_");h=Function("var __q;return function "+
h+"("+b.join()+"){var i; if(__q){__q=!__q}else if(this instanceof "+h+")this.__CLASSCONSTRUCTOR.apply(this,arguments);else{__q=!__q;i=new "+h+";i.__CLASSCONSTRUCTOR.apply(i,arguments);return i}};")();h.prototype=a.prototype;h.prototype.__CLASSCONSTRUCTOR=a;S(h,a);return h}function O(h,a,b,c){this.parameter=h;this.automation=a;this.amount=isNaN(b)?this.amount:b;this.setType(c)}function u(h,a,b,c,e){if(!h.automation)switch(h.automation=[],h.type){case "generator":h.append=u.generatorAppend;break;case "effect":h.append=
u.effectAppend;break;case "buffereffect":h.append=u.bufferEffectAppend}b=new O(a,b,c,e);h.automation.push(b);return b}function T(h,a,b){function c(){h.apply(this,b)}this.channelCount=isNaN(a)?this.channelCount:a;this.effects=[];for(c.prototype=h.prototype;a--;)this.effects.push(new c)}function D(h,a){var b=h[0].toUpperCase()+h.substr(1).toLowerCase();D[h]=a;a.decode&&(j.Sampler.prototype["load"+b]=function(c){this.load.apply(this,[D[h].decode(c)].concat([].slice.call(arguments,1)))});a.encode&&(j.AudioDevice.Recording.prototype["to"+
b]=function(c){return D[h].encode({data:this.join(),sampleRate:this.boundTo.sampleRate,channelCount:this.boundTo.channelCount,bytesPerSample:c})});return a}function P(){}function Q(){}function K(h,a){K[h]=a;K._pluginList.push({plugin:a,name:h})}function U(h,a,b,c,e,d,g){this.sampleRate=isNaN(h)?this.sampleRate:h;this.attack=isNaN(a)?this.attack:a;this.decay=isNaN(b)?this.decay:b;this.sustain=isNaN(c)?this.sustain:c;this.release=isNaN(e)?this.release:e;this.sustainTime=isNaN(d)?null:d;this.releaseTime=
isNaN(g)?null:g}function V(h,a,b,c){this.sampleRate=isNaN(h)?this.sampleRate:h;this.stepLength=isNaN(a)?this.stepLength:a;this.steps=b||[1,0];this.attack=isNaN(c)?this.attack:c}function W(h,a){this.sampleRate=isNaN(h)?this.sampleRate:h;this.schedule=[];this.reset(a)}function s(h,a,b,c,e,d){this.reset.apply(this,arguments)}function X(h,a,b,c){this.sampleRate=h;this.buffer=new n(isNaN(a)?1200:a);this.bufferSize=this.buffer.length;this.feedback=isNaN(b)?this.feedback:b;this.damping=isNaN(c)?this.damping:
c;this.invDamping=1-this.damping}function Y(h,a){this.sampleRate=isNaN(h)?this.sampleRate:h;this.setParam("kernels",a||new n(1))}function B(h,a,b){this.time=isNaN(a)?this.time:a;this.feedback=isNaN(b)?this.feedback:b;this.reset(h)}function w(h,a,b,c,e,d,g){var f=this;f.sampleRate=h;f.channelCount=isNaN(a)?f.channelCount:a;f.wet=isNaN(b)?f.wet:b;f.dry=isNaN(c)?f.dry:c;f.roomSize=isNaN(e)?f.roomSize:e;f.damping=isNaN(d)?f.damping:d;f.tuning=new w.Tuning(g||f.tuning);f.sample=function(){var c=[],b;for(b=
...
0;g<a;g++)b.push(new w.AllPassFilter(f.sampleRate,d[g]+h*f.tuning.stereoSpread,e));c.push(b);b=[]}return c}();f.numAPFs=f.APFs[0].length}function $(h,a){this.sampleRate=isNaN(h)?this.sampleRate:h;this.gain=isNaN(a)?this.gain:a}function E(h,a,b,c){var e=this,d=[0,0,0,0],g,f,i,l,t=k.sin,R=k.min,j=k.pow;e.cutoff=isNaN(a)?2E4:a;e.resonance=!b?0.1:b;e.samplerate=isNaN(h)?44100:h;e.type=c||0;e.pushSample=function(c){if(i!==e.cutoff||l!==e.resonance)g=2*t(k.PI*R(0.25,e.cutoff/(2*e.samplerate))),f=R(2*(1-
j(e.resonance,0.25)),R(2,2/g-0.5*g)),i=e.cutoff,l=e.resonance;d[3]=c-f*d[2];d[0]+=g*d[2];d[1]=d[3]-d[0];d[2]=g*d[1]+d[2];d[3]=c-f*d[2];d[0]+=g*d[2];d[1]=d[3]-d[0];d[2]=g*d[1]+d[2];return d[e.type]};e.getMix=function(c){return d[c||e.type]}}function aa(h,a,b,c){this.sampleRate=isNaN(h)?this.sampleRate:h;this.threshold=isNaN(a)?this.threshold:a;this.attack=isNaN(b)?this.attack:b;this.release=isNaN(c)?this.release:c;this._amplitude=new j.Amplitude(this.sampleRate,this.attack,this.release)}function ba(){this.reset.apply(this,
arguments)}function z(h,a){this.frequency=isNaN(a)?440:a;this.waveTable=new n(1);this.sampleRate=h;this.waveShapes=this.waveShapes.slice(0)}function ca(h,a){this.voices=[];this.sampleRate=h;this.pitch=isNaN(a)?440:this.pitch}function da(h,a,b){this.sampleRate=isNaN(h)?this.sampleRate:h;this.attack=isNaN(a)?this.attack:a;this.decay=isNaN(b)?this.decay:b}function y(h){for(var a in y.prototype)y.prototype.hasOwnProperty(a)&&(this[a]=y.prototype[a]);this.resetBuffer.apply(this,arguments)}var ea=m.Float32Array||
o,j=this;j.Float32Array=n;var F=function(){if(v.defineProperty)return v.defineProperty;if(v.prototype.__defineGetter__)return function(h,a,b){b.get&&h.__defineGetter__(a,b.get);b.set&&h.__defineSetter__(a,b.set)}}();A(j,"__define",F);A(j,"__defineConst",A);A(j,"__extend",S);A(j,"__enum",function(h,a,b){for(var c in h)(h.hasOwnProperty(c)||b)&&a.call(h,h[c],c);return h});A(j,"__class",J);O.prototype={parameter:"",automation:null,amount:1,type:"modulation",mode:null,setType:function(h){if(h){if("function"===
...
a,b){h.setParam(a,b)},absoluteAssignment:function(h,a,b){h.setParam(a,k.abs(b))}};u.__constructror=O;T.prototype={mix:0.5,type:"buffereffect",channelCount:2,append:function(h,a,b){var c=h.length,e,d,a=a||this.channelCount,b=b||h;for(e=0;e<c;e+=a)for(d=0;d<a;d++)this.effects[d].pushSample(h[e+d],0),b[e+d]=this.effects[d].getMix(0)*this.mix+h[e+d]*(1-this.mix);return b},addPreProcessing:function(){var h;for(h=0;h<this.effects.length;h++)this.effects[h].addPreProcessing.apply(this.effects[h],arguments)},
removePreProcessing:function(){var h;for(h=0;h<this.effects.length;h++)this.effects[h].removePreProcessing.apply(this.effects[h],arguments)},setParam:function(h,a){var b=this.effects.length,c;for(c=0;c<b;c++)this.effects[c].setParam(h,a)}};P.prototype={type:"effect",sink:!0,source:!0,mix:0.5,channelCount:1,append:function(h,a,b){var c=h.length,e,d,b=b||h,a=a||this.channelCount;for(e=0;e<c;e+=a)for(d=0;d<a;d++)this.pushSample(h[e+d],d),b[e+d]=this.getMix(d)*this.mix+h[e+d]*(1-this.mix);return b},addPreProcessing:function(h){h.pushSample=
this.pushSample;this.pushSample=function(){h.apply(this,arguments);return h.pushSample.apply(this,arguments)}},removePreProcessing:function(h){for(var a;a=this.pushSample.pushSample;)if(a===h||!h)this.pushSample=a,h.pushSample=null},setParam:function(h,a){this[h]=a},pushSample:function(){},getMix:function(){},reset:function(){}};Q.prototype={type:"generator",source:!0,mix:1,generatedBuffer:null,channelCount:1,append:function(h,a,b){var c=h.length,e,d,b=b||h,a=a||this.channelCount;for(e=0;e<c;e+=a){this.generate();
...
this.releaseTime)this.state=this._st=0}]};V.prototype={sampleRate:44100,stepLength:200,steps:null,attack:0,phase:0,value:0,generate:function(){var h=this.steps,a=this.sampleRate/1E3*this.stepLength*h.length,b,c;this.phase=(this.phase+1)%a;b=this.phase/a*h.length;a=b%1;b=~~b;c=h[b]-h[(b||h.length)-1];h=h[b];a<this.attack&&(h-=c-c/this.attack*a);return this.value=h},getMix:function(){return this.value},triggerGate:function(){this.phase=0}};W.prototype={sampleRate:44100,value:1,schedule:null,clock:0,
getMix:function(){return this.value},generate:function(){var h;for(h=0;h<this.schedule.length;h++)if(this.schedule[h].t--)this.value=this.schedule[h].v,this.schedule.splice(h--,1)},setValue:function(h){this.schedule.push({v:h,t:~~((+new Date-this.clock)/1E3*this.sampleRate)})},reset:function(h){this.value=isNaN(h)?this.value:h;this.clock=+new Date}};s.BiquadFilterClass=function a(){for(var b in a.prototype)a.prototype.hasOwnProperty&&(this[b]=this[b])};s.BiquadFilterClass.prototype={sampleRate:44100,
sample:0,inputs:null,outputs:null,coefs:null,pushSample:function(a){var b=this.coefs,c=this.inputs,e=this.outputs;this.sample=b.b0*a+b.b1*c[0]+b.b2*c[1]-b.a1*e[0]-b.a2*e[1];c.pop();c.unshift(a);e.pop();e.unshift(this.sample);return this.sample},getMix:function(){return this.sample},reset:function(a,b,c,e,d,g){this.inputs=[0,0];this.outputs=[0,0];this.sampleRate=isNaN(a)?this.sampleRate:a;if(1<arguments.length)this.coefs={b0:b,b1:c,b2:e,a1:d,a2:g}}};s.LowPass=function(a,b,c){var e=2*k.PI*b/a,b=k.cos(e),
c=k.sin(e)/(2*c),e=(1-b)/2,d=1+c;this.reset(a,e/d,(1-b)/d,e/d,-2*b/d,(1-c)/d)};s.HighPass=function(a,b,c){var e=2*k.PI*b/a,b=k.cos(e),c=k.sin(e)/(2*c),e=(1+b)/2,d=1+c;this.reset(a,e/d,-(1+b)/d,e/d,-2*b/d,(1-c)/d)};s.AllPass=function(a,b,c){var e=2*k.PI*b/a,b=k.cos(e),e=k.sin(e)/(2*c),c=1-e,b=-2*b,e=1+e;this.reset(a,c/e,b/e,e/e,b/e,c/e)};s.BandPass=function(a,b,c){var e=2*k.PI*b/a,b=k.cos(e),d=k.sin(e),c=k.log(2)/2*c*e/d,c=d*(k.exp(c)-k.exp(-c))/2,d=1+c;this.reset(a,c/d,0/d,-c/d,-2*b/d,(1-c)/d)};(function(a,
b){for(b=0;b<a.length;b++)a[b].prototype=new s.BiquadFilterClass})([s,s.LowPass,s.HighPass,s.AllPass,s.BandPass]);X.prototype={sample:0,index:0,store:0,feedback:0.84,damping:0.2,pushSample:function(a){this.sample=this.buffer[this.index];this.store=this.sample*this.invDamping+this.store*this.damping;this.buffer[this.index++]=a+this.store*this.feedback;if(this.index>=this.bufferSize)this.index=0;return this.sample},getMix:function(){return this.sample},reset:function(){this.samples=this.index=this.store=
0;this.buffer=new n(this.bufferSize)},setParam:function(a,b){switch(a){case "damping":this.damping=b;this.invDamping=1-b;break;default:this[a]=b}}};Y.prototype={sampleRate:44100,sample:0,pos:0,kernels:null,buffer:null,pushSample:function(a){var b,c;this.sample=0;this.buffer[this.pos]=a;for(b=0,c=this.buffer.length,a=this.pos+c;b<c;b++)this.sample+=this.kernels[b]*this.buffer[(a-b)%c];this.pos=(this.pos+1)%this.buffer.length},getMix:function(){return this.sample},setParam:function(a,b){switch(a){case "kernels":this.buffer=
new n(b.length),this.pos=0}this[a]=b}};B.prototype={sampleRate:1,time:1E3,feedback:0,bufferPos:0,buffer:null,sample:0,_rstf:1,pushSample:function(a){var b=this.buffer;b[this.bufferPos++]+=a;if(this.bufferPos>this.time*this._rstf)this.bufferPos=0;this.sample=b[this.bufferPos];b[this.bufferPos]*=this.feedback;return this.sample},getMix:function(){return this.sample},resample:function(a){var b=this.time/a;this.buffer=j.Sink.resample(this.buffer,a);this.time=a;this.bufferPos=k.round(b*this.bufferPos);
return this.buffer},reset:function(a,b){var c=this.buffer,e,a=isNaN(a)?this.sampleRate:a;e=this.sampleRate/a;this.buffer=new n(a*B.MAX_DELAY);this.bufferPos=k.round(e*this.bufferPos);this._rstf=0.0010*a;if(b){c=j.Sink.resample(c,e);for(e=0;e<c.length&&e<this.buffer.length;e++)this.buffer[e]=c[e]}return this.buffer}};B.MAX_DELAY=2;w.prototype={channelCount:2,sample:[0,0],wet:0.5,dry:0.55,damping:0.2223,roomSize:0.5,tuning:{},pushSample:function(a,b){var c=a*this.tuning.fixedGain,e=0,d;for(d=0;d<this.numCFs;d++)e+=
...
e+=b instanceof Function?"("+b+").call(this);":b.textContent||b;e=fa.inlineWorker(e);if(c)e.inject=a;return e}})();(function(a,b){function c(b,a){return a?g(b&255)+c(b>>8,a-1):""}function e(c,b){return b?e(c>>8,b-1)+g(255-c&255):""}function d(c,a,e,g){var k=b.pow,j=b.floor,C=d.convertFromBinary,n=d.convertToBinary,m=c/8,r=k(2,c),p=r/2,o=p-1,s=1/p,x=1/o;return g?e?a?function(c,b){c=j(0>c?c*p+r:c*o);return n(c,m,b)}:function(c,b){return n(j(c*o),m,b)}:a?function(c,b){return n(0>c?c+r:c,m,b)}:function(c,
b){return n(c,m,b)}:e?a?function(c,b){var a=C(c,b);return a>o?(a-r)*s:a*x}:function(c,b){return C(c,b)*x}:a?function(c,b){var a=C(c,b);return a>o?a-r:a}:function(c,b){return C(c,b)}}var g=String.fromCharCode;d.convertToBinary=function(b,a,d){return d?e(b,a):c(b,a)};d.convertFromBinary=function(c,a){var e=c.length,d=e-1,g=0,k=b.pow,j;if(a)for(j=0;j<e;j++)g+=(255-c.charCodeAt(j))*k(256,d-j);else for(j=0;j<e;j++)g+=c.charCodeAt(j)*k(256,j);return g};d.fromQ32=d(32,!0,!0,!0);d.toQ32=d(32,!0,!0,!1);d.fromQ24=
...
typeof b?c.decode:c.encode)(b)}c.decodeFrame=function(c,a,g){if(8===a){var f=new (window.Uint8Array||o)(g.length);(new b(c)).readBuffer(f,8,"Uint");for(a=0;a<g.length;a++)g[a]=127.5*(f[a]-127.5)}else(new b(c)).readBuffer(g,a,"Q");return g};c.encodeFrame=function(c,b){var g=a[(8===b?"fromUint":"fromQ")+b],f=c.length,i="",l;if(8===b)for(l=0;l<f;l++)i+=g(127.5*c[l]+127.5);else for(l=0;l<f;l++)i+=g(c[l]);return i};c.decode=function(a,d){function g(){C=f.read(4);m=f.readUint32();r=f.read(m);s=u[C]=u[C]||
[];"data"===C?(Z=~~(m/j),p=x.data=new ("undefined"!==typeof n?n:o)(Z),c.decodeFrame(r,8*j,p)):s.push(r);d&&(f.data?setTimeout(g,1):d(x))}var f=new b(a);f.read(4);var i=f.readUint32(),f=new b(f.read(i));f.read(4);f.read(4);i=f.readUint32();i=new b(f.read(i));i.readUint16();var l=i.readUint16();i.readUint32();var t=i.readUint32(),k=i.readUint16(),j=k/l;i.readUint16();var C,m,Z,r,p,s,u={},x={channelCount:l,bytesPerSample:k/l,sampleRate:t/k,chunks:u,data:p};if(d)f.data?g():d(x);else for(;f.data;)g();
return x};c.encode=function(b,d){var g=a.fromUint32,f=a.fromUint16,i=b.data,l=b.sampleRate,t=b.channelCount||1,j=b.bytesPerSample||1,n=8*j,m=t*j,o=l*m,s=i.length*j;k.pow(2,n-1);var r=[],j="",p;r.push("fmt "+g(16)+f(1)+f(t)+g(l)+g(o)+f(m)+f(n));r.push("data"+g(s)+c.encodeFrame(i,n));if(l=b.chunks)for(p in l)if(l.hasOwnProperty(p)){f=l[p];for(i=0;i<f.length;i++)j=f[i],r.push(p+g(j.length)+j)}r=r.join("");r="RIFF"+g(r.length)+"WAVE"+r;d&&setTimeout(function(){d(r)},1);return r};return c}(this.Binary,
...
function(c,e,d,g){function f(c){var b=c.outputBuffer,c=b.numberOfChannels,a,e=b.length,d=new o(c);i.ready();k=k&&k.length===e*c?k:new n(e*c);m=m&&m.length===k.length?m:new n(e*c);k.set(m);for(a=0;a<c;a++)d[a]=b.getChannelData(a);i.process(k,i.channelCount);for(a=0;a<e;a++)for(b=0;b<c;b++)d[b][a]=k[a*i.channelCount+b]}var i=this,l=a.webaudio.getContext(),j=l.createJavaScriptNode(d,0,e),k=null,m=null;i.start.apply(i,arguments);i.sampleRate=l.sampleRate;j.onaudioprocess=f;j.connect(l.destination);i._context=
...
d[f][g];b+=d[f].length}return a}};a.Recording=b})(this.Sink);da.prototype={sampleRate:44100,attack:0.01,release:0.01,sample:0,pushSample:function(a){return this.sample=k.abs((a>this.sample?this.attack:this.release)*(this.sample-a)+a)},getMix:function(){return this.sample}};y.prototype={bufferPos:-1,pushSample:function(a){this.bufferPos=(this.bufferPos+1)%this.buffer.length;0===this.bufferPos&&this.process(this.buffer);return this.buffer[this.bufferPos]=a},getMix:function(){return this.buffer[this.bufferPos]},
resetBuffer:function(a){this.bufferSize=isNaN(a)?this.bufferSize:a;this.buffer=new n(this.bufferSize);this.bufferPos=-1}};m=function(){function a(a,b,i,j){var k=1,m=0,o=0.5*a.length,s=i.length,u,w,r,p;for(p=0;p<s;p++)if(r=i[p],k*=r,0===m?(u=a,w=b,m=1):(u=b,w=a,m=0),2===r){r=u;for(var v=w,A=j,x=0.5*r.length,y=0,G=0,D=x/2,x=x/k,z=k/2,K=1*z,M=new n(2),B=void 0,L=void 0,H=void 0,I=void 0,E=void 0,F=void 0,N=void 0,J=void 0,I=H=void 0,B=0;B<x;B++,G+=K){L=M;N=(A?d:-d)*B/(2*x);L[0]=e(N);L[1]=c(N);for(L=
0;L<z;L++,y++,G++)H=r[2*y],I=r[2*y+1],E=r[2*(y+D)],F=r[2*(y+D)+1],N=H+E,J=I+F,H-=E,I-=F,v[2*G]=N,v[2*G+1]=J,v[2*(G+z)]=M[0]*H-M[1]*I,v[2*(G+z)+1]=M[0]*I+M[1]*H}}if(j){if(1===m)for(p=0;p<o;p++)a[2*p]=b[2*p],a[2*p+1]=b[2*p+1]}else if(1===m)for(p=0;p<o;p++)a[2*p]=b[2*p]/o,a[2*p+1]=b[2*p+1]/o;else for(p=0;p<o;p++)a[2*p]/=o,a[2*p+1]/=o}function b(){this.reset.apply(this,arguments)}var c=k.sin,e=k.cos,d=2*k.PI;b.prototype={factors:null,scratch:null,bufferSize:2048,reset:function(a){this.bufferSize=isNaN(a)?
...
(this[d]=a.prototype[d]);y.apply(this,[].slice.call(arguments,1));this.resetFT.apply(this,arguments)}var b=k.sqrt;a.prototype={resetFT:function(a){this.sampleRate=isNaN(a)?this.sampleRate:a;this.bandWidth=0.5*2/this.bufferSize*this.sampleRate;this.spectrum=new n(0.5*this.bufferSize);this.peak=this.peakBand=0},getBandFrequency:function(a){return this.bandwidth*a+0.5*this.bandWidth},calculateSpectrum:function(){var a=this.spectrum,e=2/this.bufferSize,d=this.bufferSize/2,g,f,i;for(i=0;i<d;i++){g=this.buffer[2*
i];f=this.buffer[2*i+1];g=e*b(g*g+f*f);if(g>this.peak)this.peakBand=i,this.peak=g;a[i]=g}}};return a}();j.ADSREnvelope=U;j.StepSequencer=V;j.UIControl=W;j.BiquadFilter=s;j.BitCrusher=function(a,b){var c=this,e=0;c.sampleRate=a;c.resolution=b?k.pow(2,b-1):k.pow(2,7);c.pushSample=function(a){return e=k.floor(a*c.resolution+0.5)/c.resolution};c.getMix=function(){return e}};j.Chorus=function(a,b,c,e){function d(){f=new n(0.1*g.sampleRate);i=0;var a,b=f.length;for(a=0;a<b;a++)f[a]=0}var g=this,f,i,j;g.delayTime=
b||30;g.depth=c||3;g.freq=e||0.1;g.sampleRate=a;g.osc=new z(a,e);g.calcCoeff=d;g.pushSample=function(a){++i>=f.length&&(i=0);f[i]=a;g.osc.generate();a=g.delayTime+g.osc.getMix()*g.depth;a*=g.sampleRate/1E3;for(a=i-k.floor(a);0>a;)a+=f.length;return j=f[a]};g.getMix=function(){return j};d()};j.CombFilter=X;j.Compressor=function(a,b,c){var e=this,d=0;e.sampleRate=a;e.scale=b||1;e.gain=isNaN(c)?0.5:c;e.pushSample=function(a){a/=e.scale;return d=(1+e.gain)*a-e.gain*a*a*a};e.getMix=function(){return d}};
j.Convolution=Y;j.Delay=B;j.Distortion=function(a){var b=new E(a,720.484),c=new E(a,723.431),e=new E(a,1),d=0;this.gain=4;this.master=1;this.sampleRate=a;this.filters=[b,c,e];this.pushSample=function(a){b.pushSample(a);d=b.getMix(1)*this.gain;d=k.atan(d)+d;0.4<d?d=0.4:-0.4>d&&(d=-0.4);c.pushSample(d);e.pushSample(c.getMix(0));return d=e.getMix(1)*this.master};this.getMix=function(){return d}};j.GainController=$;j.IIRFilter=E;j.LP12Filter=function(a,b,c){function e(){j=i*d.cutoff/d.samplerate;m=1-
j/(2*(d.resonance+0.5/(1+j))+j-2);n=m*m;o=n+1-2*k.cos(j)*m}var d=this,g=0,f=0,i=2*k.PI,j,m,n,o,s,u;d.cutoff=!b?2E4:b;d.resonance=!c?1:c;d.samplerate=a;d.pushSample=function(a){if(s!==d.cutoff||u!==d.resonance)e(),s=d.cutoff,u=d.resonance;g+=(a-f)*o;f+=g;g*=n;return f};d.getMix=function(){return f};e()};j.Limiter=aa;j.Reverb=w;j.Noise=ba;j.Oscillator=z;j.Sampler=ca;j.Amplitude=da;j.FFT=m;j.AudioProcessingUnit=y;j.AudioDevice=j.Sink=function(){return this}().Sink;(function(a,b){function c(a){return new j.BufferEffect(this,
a,[].slice.call(arguments,1))}function e(a,b,f,i){if(b){var f=f||b.prototype,j=b.prototype=new P;j.name=j.fxid=a;e[a]=J(a,b,i);e[a].createBufferBased=b.createBufferBased=c;for(i in f)f.hasOwnProperty(i)&&(j[i]=f[i])}return e[a]}j.effects=e;for(b=0;b<a.length;b++)j[a[b]]=e(a[b],j[a[b]],j[a[b]].prototype);e("BiquadAllPassFilter",s.AllPass);e("BiquadBandPassFilter",s.BandPass);e("BiquadHighPassFilter",s.HighPass);e("BiquadLowPassFilter",s.LowPass);e("FreeverbAllPassFilter",w.AllPassFilter)})("BiquadFilter,BitCrusher,Chorus,CombFilter,Compressor,Convolution,Delay,Distortion,GainController,IIRFilter,LP12Filter,Limiter,Reverb,Amplitude,FFT".split(","));
(function(a,b){function c(a,b,g,f){if(b){var g=g||b.prototype,i=b.prototype=new Q;i.name=i.fxid=a;c[a]=J(a,b,f);for(f in g)g.hasOwnProperty(f)&&(i[f]=g[f])}return c[a]}j.generators=c;for(b=0;b<a.length;b++)j[a[b]]=c(a[b],j[a[b]],j[a[b]].prototype)})("Noise,Oscillator,Sampler,ADSREnvelope,StepSequencer,UIControl".split(","));D("wav",j.PCMData);j.Automation=u;j.BufferEffect=T;j.EffectClass=P;j.GeneratorClass=Q;j.codecs=j.Codec=D;j.plugins=K;j.version="0.6.1";j.BufferEffect.prototype.addAutomation=j.EffectClass.prototype.addAutomation=
...
1;k[1]=(this.phase[1]+this.phaseOffset)%1;this._p[0]=k[0]<m?k[0]/m:(k[0]-m)/(1-m);this._p[1]=k[1]<m?k[1]/m:(k[1]-m)/(1-m)},getMix:function(q){return Math.sin(2*this._p[q]*Math.PI)}});var Noise=function(){var q=this;q.dev=audioLib.Sink(function(m,k){q.generateBuffer(m,k)},2);this.bufferSize=this.dev.bufferSize;this.sampleRate=this.dev.sampleRate;this.lfo={oscillator:audioLib.Oscillator(this.sampleRate,0),amplitude:0};this.actualVolume=this.volume=100;this.sources=[]};
Noise.prototype={addSource:function(q){console.log('Adding sound source "'+q().name+'". Total sources: '+(this.sources.length+1));var m=Array.prototype.slice.call(arguments);m[0]=this.sampleRate;q={volume:100,func:q.apply(this,m)};this.sources.push(q);return q},removeSource:function(q){console.log('Removing source "'+q.func.name+'".');this.sources.splice(this.sources.indexOf(q),1)},setVolume:function(q){this.volume=0>(100<q?100:q)?0:q;this.actualVolume=this.volume*this.volume*this.volume/1E6},setVolumeLFO:function(q,
m){this.lfo={oscillator:audioLib.Oscillator(this.sampleRate,q),amplitude:m}},generateBuffer:function(q,m){var k=this.lfo.oscillator;k.generate();this.setVolume(this.volume+k.getMix()*this.lfo.amplitude);for(k=0;k<q.length;k+=m){for(var v=0;v<this.sources.length;v++){this.sources[v].func.generate();for(var o=0;o<m;o++)q[k+o]+=this.sources[v].func.getMix(o)}for(o=0;o<m;o++)q[k+o]*=this.actualVolume}}};
